...
if __name__ == "__main__":
	...
	parser.add_argument('-o', "--output", action='store', dest='output', help="output file (JSON)")
	...
	if results.url is not None:
		...
		# Launch fuzzing
		fuzz = Fuzz_Engine(wp, results.fuzz)

		# Launch scans
		scan = Scan_Engine(wp, results.aggressive)
